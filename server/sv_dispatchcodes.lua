...
dispatchCodes = {
	...
	["civdown"] = { displayCode = '10-69', description = "Civilan Down", radius = 0, recipientList = { 'ambulance' }, blipSprite = 126, blipColour = 3, blipScale = 1.5, blipLength = 2, sound = "dispatch", blipflash = "false"},
	["civdead"] = { displayCode = '10-69', description = "Civilan Bled Out", radius = 0, recipientList = { 'ambulance' }, blipSprite = 126, blipColour = 3, blipScale = 1.5, blipLength = 2, sound = "dispatch", blipflash = "false"},
	...
	["officerdown"] = { displayCode = '10-99', description = "Officer Down", radius = 15.0, recipientList = { 'police' }, blipSprite = 526, blipColour = 1, blipScale = 1.5, blipLength = 2, sound = "panicbutton", offset = "false", blipflash = "false"},
	...
	["ifruitstorerobbery"] = { displayCode = '10-90A', description = "iFruit Store Robbery In Progress", radius = 0, recipientList = { 'police' }, blipSprite = 52, blipColour = 1, blipScale = 1.5, blipLength = 2, sound = "robberysound", offset = "false", blipflash = "false"},
	["poweroutage"] = { displayCode = '10-90B', description = "Power Outage at iFruit Store", radius = 0, recipientList = { 'police' }, blipSprite = 52, blipColour = 1, blipScale = 1.5, blipLength = 2, sound = "robberysound", offset = "false", blipflash = "false"},
	["powerboxexplosion"] = { displayCode = '10-90C', description = "Explosion at iFruit Store", radius = 0, recipientList = { 'police' }, blipSprite = 436, blipColour = 1, blipScale = 1.5, blipLength = 2, sound = "Lose_1st", sound2 = "GTAO_FM_Events_Soundset", offset = "false", blipflash = "false"},
